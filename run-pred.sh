...
runDet() {
	 ...
	 python ./detect.py --weights ./best.pt --source "v4l2src device=/dev/video0 ! video/x-raw, format= GRAY8 ! videoconvert ! appsink max-buffers=1 drop=true " --view-img --no-trace
